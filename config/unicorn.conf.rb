worker_processes 2
working_directory '/data/app/unify/current'
listen '/data/app/unify/shared/sockets/unicorn.sock', :backlog => 64
timeout 30
pid '/data/app/unify/current/tmp/pids/unicorn.pid'
stderr_path '/data/app/unify/shared/log/unicorn.stderr.log'
stdout_path '/data/app/unify/shared/log/unicorn.stdout.log'
preload_app true
